...
public class BasicTest {
    ...
    public void people_and_companies() {
        ...
        final Person0 acquaintance = new Person0(null, null, new EmailAddress0("tom.tackson@come-company.com"));
        ...
        final Collection<Person0>  people    = Arrays.asList(wife, mother, son, daughter, acquaintance, doctor, barber);
